<?php
/**
 * filename	:	html2pdf.php
 * version	:	1.7
 *
 * You can use this library as follows:
 *
 *		Step 1: Initiliaze the HTML2PDF class and (optionally) set server settings
 *
 *		require 'html2pdf.php';						// make sure that the class is there
 *
 *      $pdf = new HTML2PDF($license);				// initialize with your private license key
 *      
 ...
 *  }
 *  
 * Please see https://www.html2pdf.co.uk/php-library for a list of error codes and their meanings. 
 *
 */

class HTML2PDF {
	private $endpoint = 'https://api.html2pdf.co.uk/';
	...
	// Allows you to activate debugging on the HTML2PDF servers for your conversions when support asks for it
